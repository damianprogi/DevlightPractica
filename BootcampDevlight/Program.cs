...
void Ejercicio1() //Dado un valor, devolver un mensaje que diga “El valor es mayor que 100 sólo cuando se cumpla dicha condición.
{
...
void Ejercicio2() // Pedir un número entero por teclado y calcular si es par o impar.
{
...
void Ejercicio3() // Teniendo un valor entero, verificar si se cumple o no que ese valor es el doble de un impar. Por ejemplo, 14 cumple con esta condición.
{
    int valor = 16;
...
string Ejercicio4() // Dada un número del 1 al 10, devolver su “versión” en números romanos.
{
    int valorDecimal = 4;
...
void Ejercicio6() // Escribir un programa que calcule el tipo de un triángulo conociendo la longitud de sus 3 lados. También que calcule su perímetro y su área.
{
...
void Practica1()
{
    ...
    Console.WriteLine(Enumerable.Reverse(letras).ToArray());
    //for (int i = 2; i > -1; i--)
    //{
...
void Practica2()
{
    ...
    do
    {
        Console.WriteLine("ing. un núm de 0 a 9: ");
        sePudo = int.TryParse(Console.ReadLine(), out num);
    } while (!sePudo);
...
string Practica3(int valor1, int valor2)
{
    ...
    return $"Before: a = {valor1}, b = {valor2}; After: a = {valor2}, b = {valor1}";
